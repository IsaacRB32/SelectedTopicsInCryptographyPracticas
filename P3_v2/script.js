...
function CalcularMultiplicacionEscalar(){
        ...
        function CalcularDobladoPuntos(a,b,n,x1,y1,contadorDoblados){
            ...
            for (let i = 0; i < contadorDoblados; i++) {
                ...
                procedimientoHTML += `<h1 class="display-2 text-primary" style="text-align: center; margin-left: 10%; margin-top: 3%; margin-bottom: 3%; margin-right: 10%;" id="valorFinalPunto"><b>${valorIteracion} P</b></h1>`;
                // Obtiene los valores de las casillas
                ...
                if(n<=0){
                    ...
                    if(denominador == 0){
                        ...
                        procedimientoHTML += `<p class="lead" id="lambda" style="margin-left: 10%; margin-top: 5%; margin-bottom: 5%; margin-right: 10%;"><b>lambda</b> = (3x<sub>1</sub><sup>2</sup> + a)/(2y<sub>1</sub>) = [3*(${x1Temp})<sup>2</sup> + ${a}]/(2*${y1Temp}) = (${numeradorPositivo})/(${denominadorPositivo}) = (${numeradorPositivo}) * (${denominadorPositivo})<sup>-1</sup></p>`;
                        // Tabla del algoritmo extendido de Euclides
                        procedimientoHTML += `<h1 class="display-6" style="text-align: center; margin-bottom: 5%;" id="tituloTablas"><b>Algoritmo extendido de Euclides</b></h1>`;
                        ...
                        procedimientoHTML += `<p class="lead" id="continuacionLambda" style="margin-left: 10%; margin-top: 5%; margin-bottom: 5%; margin-right: 10%;"><b>lambda</b> = (${numeradorPositivo}) * (${denominadorPositivo})<sup>-1</sup> = (${numeradorPositivo})*(${inversoDenominador}) mod ${n} = ${valorlambdaPositivo}</p>`;
                        // Se calcula x3
                        ...
                        procedimientoHTML += `<p class="lead" id="valorx3" style="margin-left: 10%; margin-top: 5%; margin-bottom: 5%; margin-right: 10%;"><b>x<sub>3</sub></b> = [(lambda)<sup>2</sup> - 2*x<sub>1</sub>] mod (n) = [(${valorlambdaPositivo})<sup>2</sup> - 2*${x1Temp}] mod ${n} = ${x3Positivo}</p>`;
                        // Se calcula y3
                        ...
                        procedimientoHTML += `<p class="lead" id="valory3" style="margin-left: 10%; margin-top: 5%; margin-bottom: 5%; margin-right: 10%;"><b>y<sub>3</sub></b> = ((lambda) * ((x<sub>1</sub>) - (x<sub>3</sub>)) - (y<sub>1</sub>)) mod (n) = ((${valorlambdaPositivo}) * ((${x1Temp}) - (${x3Positivo})) - (${y1Temp})) mod (${n}) = ${y3Positivo}</p>`;
                        procedimientoHTML +=  `<h1 class="display-7" style="text-align: center; margin-left: 10%; margin-top: 3%; margin-bottom: 3%; margin-right: 10%;" id="resultadoAlgoritmoEuclides"><b>P(${x3Positivo},${y3Positivo})</b></h1>`;
        ...
        for (let i = 0; i < (x1.length-1); i++) {
            ...
            if(i==0){
                ...
                procedimientoHTML2 += `<h1 class="display-2 text-primary" style="text-align: center; margin-left: 10%; margin-top: 3%; margin-bottom: 3%; margin-right: 10%;" id="valorFinalPunto1"><b>${potencia1}P + ${potencia2}P = ${potencia3}P</b></h1>`;
            }else{
                potencia2 = 2**potencia[i+1];
                potencia4 = potencia3+(potencia2);
                procedimientoHTML2 += `<h1 class="display-2 text-primary" style="text-align: center; margin-left: 10%; margin-top: 3%; margin-bottom: 3%; margin-right: 10%;" id="valorFinalPunto1"><b>${potencia3}P + ${potencia2}P = ${potencia4}P</b></h1>`;
            ...
            if(n<=0){
                ...
                if(denominador<0){
                    ...
                    procedimientoHTML2 += `<div style="visibility: none; margin-bottom: 0%; margin-left="25%"; margin-right="25%";" class="alert alert-danger" role="alert" id="mensajeError1" ">El valor tiende a infinito</div>`;
                    //break;
                }else{
                    denominadorPositivo = denominador;
                }
                ...
                if(denominador == 0){
                    ...
                    operaciones.style.display = "block";
                    // Texto inicial de lambda
                    procedimientoHTML2 += `<p class="lead" id="lambda1" style="margin-left: 10%; margin-top: 5%; margin-bottom: 5%; margin-right: 10%;"><b>lambda</b> = (y<sub>2</sub> - y<sub>1</sub>)/(x<sub>2</sub> - x<sub>1</sub>) = (${y2Temp} - ${y1Temp})/(${x2Temp} - ${x1Temp}) = (${numeradorPositivo})/(${denominadorPositivo}) = (${numeradorPositivo}) * (${denominadorPositivo})<sup>-1</sup></p>`;
                    // Tabla del algoritmo extendido de Euclides
                    procedimientoHTML2 += `<h1 class="display-6" style="text-align: center; margin-bottom: 5%;" id="tituloTablas1"><b>Algoritmo extendido de Euclides</b></h1>`;
                    // Se realiza el algoritmo extendido de Euclides
                    let resultadoEuclides = AlgoritmoExtendidoEuclides(denominadorPositivo,n);
                    let inversoDenominador = resultadoEuclides.inverso;
                    ...
                    // Continuación de la operación Lambda debajo de la tabla
                    procedimientoHTML2 += `<p class="lead" id="continuacionLambda1" style="margin-left: 10%; margin-top: 5%; margin-bottom: 5%; margin-right: 10%;"><b>lambda</b> = (${numeradorPositivo}) * (${denominadorPositivo})<sup>-1</sup> = (${numeradorPositivo})"+" * (${inversoDenominador}) mod ${n} = ${valorlambdaPositivo}</p>`;
                    // Se calcula x3
                    ...
                    procedimientoHTML2 += `<p class="lead" id="valorx31" style="margin-left: 10%; margin-top: 5%; margin-bottom: 5%; margin-right: 10%;"><b>x<sub>3</sub></b> = ((lambda)<sup>2</sup> - (x<sub>1</sub>) - (x<sub>2</sub>)) mod (n) = ((${valorlambdaPositivo})<sup>2</sup> - (${x1Temp}) - (${x2Temp})) mod ${n} = ${x3Positivo}</p>`;
                    // Se calcula y3
                    let y3 = (valorlambdaPositivo*(x1Temp - x3Positivo)-y1Temp);
                    let y3Positivo;
                    // Realiza el inverso aditivo en caso de que y3 sea negativo
                    ...
                    procedimientoHTML2 += `<p class="lead" id="valory31" style="margin-left: 10%; margin-top: 5%; margin-bottom: 5%; margin-right: 10%;"><b>y<sub>3</sub></b> = ((lambda) * ((x<sub>1</sub>) - (x<sub>3</sub>)) - (y<sub>1</sub>)) mod (n) = ((${valorlambdaPositivo}) * ((${x1Temp}) - (${x3Positivo})) - (${y1Temp})) mod (${n}) = ${y3Positivo}</p>`;
                    procedimientoHTML2 +=  `<h1 class="display-7" style="text-align: center; margin-left: 10%; margin-top: 3%; margin-bottom: 3%; margin-right: 10%;" id="resultadoAlgoritmoEuclides1"><b>P(${x3Positivo},${y3Positivo})</b></h1>`;
                    x1[1] = x3Positivo;
                    y1[1] = y3Positivo;
        ...
        document.getElementById("contenedorSuma").innerHTML = procedimientoHTML2;
            ...
            function AlgoritmoExtendidoEuclides(a,n){
                ...
                procedimientoHTML1+= `<h1 class="display-7" style="text-align: center; margin-left: 10%; margin-top: 3%; margin-bottom: 3%; margin-right: 10%;" id="resultadoAlgoritmoEuclides">${r[contador+1]} = (${s[contador+1]}) * (${n}) + (${t[contador+1]}) * (${a})"</h1>`;
